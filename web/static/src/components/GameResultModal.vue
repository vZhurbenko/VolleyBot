<template>
  ...
  >
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md" @click.stop>
      <!-- Заголовок -->
      <div
        class="px-6 py-4 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white rounded-t-lg"
      >
        <h3 class="text-lg font-semibold text-gray-900">Результат игры</h3>
        <button
          @click="$emit('close')"
      ...
      <div class="p-6 space-y-4">
        <form id="game-result-form" @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div class="space-y-4">
            <!-- Исход игры -->
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2"> Исход игры * </label>
              <div class="grid grid-cols-3 gap-3">
                <label
                  ...
                  "
                >
                  <input v-model="form.result" type="radio" value="win" class="sr-only" />
                ...
                <label
                  ...
                  "
                >
                  <input v-model="form.result" type="radio" value="draw" class="sr-only" />
                ...
                <label
                  ...
                  "
                >
                  <input v-model="form.result" type="radio" value="loss" class="sr-only" />
